...
const Inicio = () => {
    return (
        <div className="inicio">
            ...
            <h2>Melhores Hqs que você pode encontrar</h2>
            ...
            <a href="https://github.com/jsx-eslint/eslint-plugin-jsx-a11y/blob/HEAD/docs/rules/anchor-is-valid.md" className="botao botao1">IR PARA A LOJA</a>
            </div>
        </div>
    )
}
